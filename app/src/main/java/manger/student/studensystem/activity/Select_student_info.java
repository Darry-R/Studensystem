...
/**
 *展示学生信息的activity
 * Created by Darry.r on 2017/12/19.
 */
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                select_button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        /*AlertDialog.Builder select_builder=new AlertDialog.Builder(Select_student_info.this);
                        select_builder.setTitle("学生详细信息");
                        StringBuilder sb=new StringBuilder();
                        sb.append("姓名: "+student_info.getName()+"\n");
                        sb.append("性别:"+student_info.getSex()+"\n");
                        sb.append("学号：" + student_info.getId() + "\n");
                        sb.append("手机号：" + student_info.getPhone() + "\n");
                        int math = student_info.getMathScore();//数学成绩
                        sb.append("数学成绩：" + math + "\n");
                        int chinese = student_info.getChineseScore();
                        sb.append("语文成绩：" + chinese + "\n");
                        int english = student_info.getEnglishScore();
                        sb.append("英语成绩：" + english + "\n");
                        int sum = math + chinese + english;//总成绩
                        sb.append("总成绩：" + sum + "\n");
                        sb.append("排名："+student_info.getOrder()+"\n");
